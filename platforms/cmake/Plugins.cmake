...
FILE (GLOB plugins_vm RELATIVE ${platdir} ${platdir}/vm-*)
...
MACRO (INTERNAL_PLUGIN plugin)
  ...
  ELSE (DEFINED ${plugin}_sources)
    FOREACH (dir ${src}/vm/intplugins ${src} ${cross}/plugins ${platdir}/plugins)
      SET (tmp "")
  ...
  FOREACH (dir ${platdir}/plugins ${platdir})
...
MACRO (EXTERNAL_PLUGIN plugin)
  ...
  IF (DEFINED ${plugin}_sources)
    SET (plugin_sources ${${plugin}_sources})
  ELSE (DEFINED ${plugin}_sources)
    FOREACH (dir ${src}/plugins ${src} ${cross}/plugins ${platdir}/plugins ${platdir})
      SET (tmp "")
      AUX_SOURCE_DIRECTORY (${dir}/${plugin} tmp)
      STRING_APPEND (plugin_sources "${tmp}")
    ENDFOREACH (dir)
